...
const WorkExperience = ({initialData,jobId}:WorkExperienceProps) => {
    ...
    const selectedOption=option.find(option =>option.value===initialData. yearsofExperience)
  ...
  return (
    <div className="mt-6 border bg-neutral-100 rounded-md p-4">
     ...
     {!isEditing &&<p className={cn("text-sm mt-2 text-gray-800",!initialData?. yearsofExperience&& "text-neutral-500 italic")}>{selectedOption?.label ||"No Work Experience"}</p>}
     {/*on editing */}
     { isEditing &&(
     <Form{...form}>
