...
const JobMode = ({initialData,jobId}:JobModeProps) => {
    ...
    const selectedOption=option.find(option =>option.value===initialData.workMode)
  ...
  return (
    <div className="mt-6 border bg-neutral-100 rounded-md p-4">
     ...
     {!isEditing &&<p className={cn("text-sm mt-2 text-gray-800",!initialData?.workMode&& "text-neutral-500 italic")}>{selectedOption?.label ||"No Timing Added"}</p>}
     {/*on editing */}
     { isEditing &&(
     <Form{...form}>
